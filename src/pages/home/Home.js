          ...
          {showModalWelcome && (
              <div className="welcome-modal">
                  <div className="welcome-modal-content">
                    ...
                    <p>Ik heb alleen de "voorkant" hoeven bouwen, dus het deel dat jij als gebruiker ziet. Dat brengt beperkingen met zich mee: omdat er geen echte server aan de "achterkant" aanwezig is, kunnen gegevens niet langdurig worden opgeslagen. Je favoriete kattenplaatjes worden bewaard zolang de applicatie is geopend, en verdwijnen na het verversen van de pagina of het afsluiten van de browser. Je profielfoto verdwijnt zodra je naar een andere pagina binnen deze website gaat. Je gebruikersnaam en wachtwoord blijven actief zolang de applicatie draait, en na afsluiten worden deze nog ongeveer een uur bewaard op een soort simulatieserver. Als je deze website een dag later opnieuw bezoekt, moet je dus eerst jezelf opnieuw registreren.</p>
