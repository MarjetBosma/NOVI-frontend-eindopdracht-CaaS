    ...
    useEffect(() => {
        ...
        async function onSubmit(data) {
            ...
            try {
                ...
                toggleError(true);
                setErrorMessageSignup("Registratie mislukt. Mogelijke oorzaken: 1) Gebruiker is al bekend 2) Typefout in je invoer 3) Server reageert niet, probeer het later opnieuw.");
            }
            toggleLoading(false);
        }
